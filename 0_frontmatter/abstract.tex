\begin{abstracts}  
    ...
    Moving beyond controlled lab settings, this research leverages a proprietary, realistically labeled industrial dataset to evaluate model performance under conditions that mirror real-world challenges, including class imbalance and previously unseen fault types.

    A systematic comparison of autoencoder (AE) architectures—including Vanilla, Multi-Head, Classification-Only, and a novel Bottleneck AE—was conducted under unsupervised, semi-supervised, and fully supervised training paradigms.
    Furthermore, an Anomaly Reinforced Autoencoder (ARAE) was proposed to enhance robustness in data-scarce scenarios.
